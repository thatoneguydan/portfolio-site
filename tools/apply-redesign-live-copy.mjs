...
async function main() {
  ...
  if (/const descriptions =/.test(videoJs) || /descriptions\[id\]/.test(videoJs)) throw new Error('Legacy video description map remains');
  ...
  if (/const descriptions =/.test(homeVideoJs) || /descriptions\[id\]/.test(homeVideoJs)) throw new Error('Legacy homepage video description map remains');
